            ...
            <>
              ...
              {state.selectedItem ? (
                <section className="flex w-full gap-2 truncate">
                  <p className="truncate text-md font-medium text-primary !m-0">
                    {state.selectedItem?.label}
                  </p>
                  {state.selectedItem?.supportingText && (
                    <p className="text-md text-tertiary !m-0">
                      {state.selectedItem?.supportingText}
                    </p>
                  )}
                </section>
              ) : (
                <p className={cx("text-md text-placeholder !m-0", isDisabled && "text-disabled")}>
                  {placeholder}
                </p>
              )}
